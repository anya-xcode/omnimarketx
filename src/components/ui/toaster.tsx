...
export function Toaster() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-36 z-[90] flex flex-col items-center gap-2 px-4 lg:bottom-6 lg:items-end lg:pr-24" aria-live="polite">
      {toasts.map((t) => {
